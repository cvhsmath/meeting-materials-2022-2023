...
\begin{minipage}{\textwidth}
	...
	\includegraphics[width=0.25\textwidth]{images/AMC-10-2014B-P4.png}
\end{minipage}
\vspace{4cm}
...
\begin{minipage}{\textwidth}
	...
	\end{wrapfigure}
	\noindent Six regular hexagons surround a regular hexagon of side length $1$ as shown. What is the area of $\triangle{ABC}$?
\end{minipage}
\vspace{4cm}
